    ...
    <div className="py-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Manage tenant information and leases</p>
        </div>
      ...
      <div className="bg-background rounded-xl shadow-sm border p-4 mb-6">
        <div className="flex items-center gap-4 mb-6">
          <div className="relative flex-1">
            ...
            <Input placeholder="Find tenant by name, email, or apartment..." className="pl-9" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {MOCK_TENANTS.map((tenant) => (
            <div key={tenant.id} className="bg-secondary/20 rounded-lg p-4 hover:bg-secondary/40 transition-colors group relative">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <div className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2 text-muted-foreground"><path d="M19 21V5a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v16"/><path d="M1 21h22"/><path d="M18 21v-4h-6v4"/><path d="M6 21v-2"/><path d="M2 9h20"/><path d="M2 13h20"/><path d="M2 17h20"/></svg>
                    <span>Apartment</span>
                  </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{new Date(tenant.leaseStart).toLocaleDateString()} - {new Date(tenant.leaseEnd).toLocaleDateString()}</span>
                </div>
